...
var odataUri = function (uriSegments) {
    var that,
        uri,
        segments,
        stringify,
    ...
    stringify = function (uriObject) {
            ...
            if (p !== undefined && opt[p] !== null) {
                switch (p) {
                    ...
                    case 'skiptoken':
                        ...
                        qopts += "$" + p + "=" + querystring.escape(opt[p]);
                        needAmpersand = true;
                        break;
                }
            }
        ...
        uriObject.uri += (qopts !== '' ? '?' + qopts : ''); //require('querystring').escape((qopts !== '' ? '?' + qopts : ''));
